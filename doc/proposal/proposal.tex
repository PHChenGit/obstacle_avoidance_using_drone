...
\newcommand{\chineseUniversity}{國立臺北科技大學}
\newcommand{\chineseDep}{資訊工程所}
\newcommand{\chineseCourseName}{自主移動式機器人}
\newcommand{\chineseProposal}{期末專題提案}
...
\newcommand{\engCourseName}{Mobile Robots}
\newcommand{\engProposal}{proposal}

\newcommand{\chineseTitle}{無人機避障基於動態視窗演算法}
\newcommand{\englishTitle}{Obstacle Avoidance Using Dynamic Window Approach For Drone}

\newcommand{\studentChineseName}{陳柏勳, 鄭泳禎}
\newcommand{\profChineseName}{林惠勇}
